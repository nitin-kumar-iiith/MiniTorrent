...
void *SendFileName(void *ptr)
{
    ...
    // send(network_socket, &dataLength, sizeof(uint32_t), MSG_CONFIRM);         // Send the data length
    // send(network_socket, dataToSend.c_str(), dataToSend.size(), MSG_CONFIRM); // Send the string
    //                                                                           // data
    // ////////////////////////////////////
    ////////////////////
    ///////////////////
