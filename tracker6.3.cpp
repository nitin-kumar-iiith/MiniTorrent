...
{ //File may already exist
    ...
    string SHA_FIle_Name = filekanaam + '_' + grpID;
    FILE *SHA_FILE_PIECE;
    ...
    while (true)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                temp_Sha_Holder.pieceNum = piece_Number;
                strcpy(temp_Sha_Holder.sha_value, buffer);
    ...
    else
    {
        ...
        strcpy(EntireFileSHa.FileName, buffer);
        FILE *SHA_FILE_FULL;
